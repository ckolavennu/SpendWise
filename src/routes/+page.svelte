			...
			<div class="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
				<Card.Root class="border-white/10 bg-card/80 shadow-xl shadow-black/10 backdrop-blur">
					...
					<Card.Content class="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
						<a href={resolve('/transactions')}>
							<Button class="w-full justify-start" variant="secondary">Add or edit transactions</Button>
						</a>

						<a href={resolve('/categories')}>
							<Button class="w-full justify-start" variant="secondary">Manage categories</Button>
						</a>

						<a href={resolve('/reports')}>
							<Button class="w-full justify-start" variant="secondary">Open analytics reports</Button>
						</a>

						<a href={resolve('/budget')}>
							<Button class="w-full justify-start" variant="secondary">Update monthly budget</Button>
						</a>
					</Card.Content>
				</Card.Root>
